...
class Notepad(QtWidgets.QMainWindow):
    ...
    def createActions(self):
        self.newAction = QtWidgets.QAction(QtGui.QIcon('images/new.png'), "جديد", self,
                                           shortcut=QtGui.QKeySequence.New, statusTip="صفحه جديد",
                                           triggered=self.newFile)

        self.openAction = QtWidgets.QAction(QtGui.QIcon('images/open.png'), "باز کردن",
                                            self, shortcut=QtGui.QKeySequence.Open,
                                            statusTip="باز کردن فايل ", triggered=self.openFileEvent)

        self.saveAction = QtWidgets.QAction(QtGui.QIcon('images/save.png'), "ذخيره", self,
                                            shortcut=QtGui.QKeySequence.Save,
                                            statusTip="ذخيره فايل", triggered=self.save)

        self.saveAsAction = QtWidgets.QAction(QtGui.QIcon('images/save.png'), "ذخيره به", self,
                                              shortcut=QtGui.QKeySequence.SaveAs,
                                              statusTip="... ذخيره به عنوان",
                                              triggered=self.saveAs)

        self.printAction = QtWidgets.QAction(QtGui.QIcon('images/print.ico'), "چاپ", self,
                                             shortcut=QtGui.QKeySequence.Print,
                                             statusTip="چاپ فايل",
                                             triggered=self.printText)

        self.exitAction = QtWidgets.QAction(QtGui.QIcon('images/exit.png'), "خارج", self, shortcut="Ctrl+Q",
                                            statusTip="... بيرون رفتن", triggered=self.close)

        self.undoAction = QtWidgets.QAction(QtGui.QIcon('images/undo.png'), "لغو", self,
                                            shortcut=QtGui.QKeySequence.Undo,
                                            statusTip="لغو کردن",
                                            triggered=self.text.undo)

        self.cutAction = QtWidgets.QAction(QtGui.QIcon('images/cut.png'), "برش", self,
                                           shortcut=QtGui.QKeySequence.Cut,
                                           statusTip="برش متن",
                                           triggered=self.text.cut)

        self.copyAction = QtWidgets.QAction(QtGui.QIcon('images/copy.png'), "کپي", self,
                                            shortcut=QtGui.QKeySequence.Copy,
                                            statusTip="کپي کردن",
                                            triggered=self.text.copy)

        self.pasteAction = QtWidgets.QAction(QtGui.QIcon('images/paste.png'), "چسباندن", self,
                                             shortcut=QtGui.QKeySequence.Paste,
                                             statusTip="چسباندن متن",
                                             triggered=self.text.paste)

        self.clearAction = QtWidgets.QAction(QtGui.QIcon('images/clear.ico'), "پاک کردن", self,
                                             statusTip="پاک کردن حافظه کپي",
                                             triggered=self.clearClipboard)

        self.deleteAction = QtWidgets.QAction(QtGui.QIcon("images/delete.png"), "حذف", self,
                                              statusTip="حذف موارد انتخاب شده",
                                              triggered=self.delete)

        self.findAction = QtWidgets.QAction(QtGui.QIcon("images/find.png"), "يافتن", self,
                                            statusTip="جست و جو براي يافتن", triggered=self.findText, shortcut=QtGui.QKeySequence.Find)

        self.findNextAction = QtWidgets.QAction(QtGui.QIcon("images/find.png"), "بعدی را پیدا کنید", self,
                                                statusTip="متن را پیدا کنید", triggered=self.findNextText,
                                                shortcut=QtGui.QKeySequence.FindNext)

        self.replaceAction = QtWidgets.QAction(QtGui.QIcon("images/replace.png"), "جاي گزيني", self,
                                               statusTip="... جايگزين کردن", triggered=self.replaceText,
                                               shortcut=QtGui.QKeySequence.Replace)

        self.selectAllAction = QtWidgets.QAction(QtGui.QIcon('images/selectAll.png'), "انتخاب همه", self,
                                                 shortcut=QtGui.QKeySequence.SelectAll,
                                                 statusTip="انتخاب همه متن",
                                                 triggered=self.text.selectAll)

        self.dateAction = QtWidgets.QAction(QtGui.QIcon("images/date.png"), "تاريخ :-)", self, shortcut="F5",
                                            statusTip="... چاپ تاريخ",
                                            triggered=self.dateEvent)

        self.fontAction = QtWidgets.QAction(QtGui.QIcon("images/font.png"), "فونت", self,
                                            statusTip="انتخاب فونت و سايز", triggered=self.setFont_)

        self.toolBarAction = QtWidgets.QAction(QtGui.QIcon("images/check.png"), "جعبه ابزار", self,
                                               statusTip="جعبه ابزار",
                                               triggered=self.toggleToolBar)

        self.aboutAction = QtWidgets.QAction(QtGui.QIcon("images/about.png"), "درباره", self, triggered=self.about)

        self.aboutQtAction = QtWidgets.QAction(QtGui.QIcon("images/qt.png"), "درباره qt", self,
